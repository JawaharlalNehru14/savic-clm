...
const Header = (props) => {
  ...
  // Function to handle color theme changes
  // Function to handle color theme changes
  const changeColorTheme = (
    ...
    document.documentElement.style.setProperty("--TEMEBGHOVER", hoverBgColor);
    document.documentElement.style.setProperty(
      "--THEMETXTHOVER",
      hoverTextColor
    );
  ...
  return (
    <>
      <Container fluid className={`headerbg ${HeaderCSS.HeaderBg}`}>
        <Row>
          <Col xs={12} md={3} lg={2} className="pb-2">
            <Button
              className={`headerbg ${HeaderCSS.HeaderArrowButton}`}
              onClick={Subheader}
            >
              {isUpIcon ? (
          ...
          <Col xs={12} md={6} lg={7} className="pb-2">
          ...
          <Col xs={12} md={3} lg={3} className="pb-2">
            ...
            <span className={HeaderCSS.tooltip}>
              ...
              >
                <div
                  className={`offcanvas-header themebgclr ${HeaderCSS.canvasHeader}`}
                >
                  <h5
                    className="themetxtclr offcanvas-title"
          ...
          >
            <Row className="headerbg">
              <Col
                ...
                md={3}
                lg={1}
                className={`p-lg-1 themebgclr themebghover ${HeaderCSS.NavlinkBg}`}
                onClick={() => handleNavLinkClick("HeaderContent")}
              >
                <div className="zoom">
                  <div
                    className={`mb-auto themetxtclr  themetxthover ${HeaderCSS.text}`}
                  >
                    Home
                  </div>
                  <div className={`mt-auto ${HeaderCSS.iconWrapper}`}>
                    <FontAwesomeIcon
                      icon={faHome}
                      className={`themetxtclr ${HeaderCSS.NavIcon}`}
                    />
                  </div>
                </div>
              </Col>
              ...
              >
                <div className="zoom">
                  <div
                    className={`mb-auto themetxtclr ${HeaderCSS.text}`}
              ...
              >
                <div className={HeaderCSS.navi}>
                  <NavDropdown
                    title={<span className="themetxtclr">Configure</span>}
