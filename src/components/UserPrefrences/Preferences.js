...
const Preferences = ({ isOpen, onClose, changeColorTheme }) => {
  ...
  const handleColorThemeChange = (backgroundColor, textColor) => {
    changeColorTheme(backgroundColor, textColor);
  };

  return (
    <Modal show={isOpen} onHide={() => onClose(false)} size="lg">
      <Modal.Header className="themebgclr themetxtclr" closeButton>
          ...
          <Tab eventKey="1" title="My Settings">
            ...
            <div className="color-circles">
              ...
              <div
                ...
                onClick={() =>
                  changeColorTheme("#17866f", "white", "#016a54", "white")
                }
              ></div>
              <div
                className="color-circle3"
                onClick={() =>
                  changeColorTheme("#cc3838", "white", "#b00000", "white")
                }
              ></div>
              <div
                className="color-circle4"
                onClick={() =>
                  changeColorTheme("#007aff", "white", "#0557b0", "white")
                }
              ></div>
            </div>
          </Tab>
