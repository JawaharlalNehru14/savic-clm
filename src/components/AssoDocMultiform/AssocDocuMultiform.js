      ...
      <Container fluid className={AssocdocMultistepformCSS.MultiBg}>
        ...
        <Row className="p-3 p-md-5">
          ...
          >
            {currentStep > 0 && (
              <div
                className={` themebgclr ${AssocdocMultistepformCSS.movingButton}`}
                onClick={handlePrevious}
              >
                <p
                  className={`themetxtclr ${AssocdocMultistepformCSS.btnNext}`}
                >
                  Previous
                </p>
          ...
          <Col xs={12} lg={1} className="mb-3 d-flex justify-content-center">
            {currentStep === 4 && (
              <div
                className={` themebgclr ${AssocdocMultistepformCSS.CreateButton}`}
              >
                <p
                  className={`themetxtclr ${AssocdocMultistepformCSS.btnNext}`}
                >
          ...
          <Col xs={12} lg={2} className="mb-3 d-flex justify-content-center">
            {currentStep === 4 && (
              <div
                className={` themebgclr ${AssocdocMultistepformCSS.PublishButton}`}
              >
                <p
                  className={`themetxtclr ${AssocdocMultistepformCSS.btnNext}`}
                >
          ...
          <Col xs={12} lg={3} className="mb-3 d-flex justify-content-center">
            {currentStep === 4 && (
              <div
                className={` themebgclr ${AssocdocMultistepformCSS.ApprovalButton}`}
          ...
          <Col xs={12} lg={2} className="mb-3 d-flex justify-content-center ">
            {currentStep === 4 && (
              <div
                className={`themebgclr ${AssocdocMultistepformCSS.DiscardButton}`}
              >
                <p
                  className={`themetxtclr ${AssocdocMultistepformCSS.btnNext}`}
                >
